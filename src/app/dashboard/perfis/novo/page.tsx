...
import { FlavorProfileForm } from "@/components/perfis/flavor-profile-form";

export default async function NewFlavorProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <h1 className="text-2xl font-bold">{t("profiles.newProfile")}</h1>
      <FlavorProfileForm roastSessions={roastOptions} />
    </div>
  );
}
